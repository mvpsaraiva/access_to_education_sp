...
## Function to properly dissolve polygons, eliminating inner island and fixing 
## bad geometry

## source:
## https://github.com/ipeaGIT/urbanformbr/blob/main/R/fun_support/dissolve_polygons.R
